...
export default function MobileMenu() {
  ...
  const serviceQuickLinks = [
    { to: "/services", label: m.mobile.startup },
    { to: "/services", label: m.mobile.fablab },
    { to: "/services", label: m.mobile.software },
    { to: "/services", label: m.mobile.agro },
  ];
        ...
        <div className="rounded-[26px] border border-slate-200/80 bg-white/85 p-2 shadow-[0_22px_45px_-16px_rgba(12,38,74,0.7)] backdrop-blur-xl dark:border-white/15 dark:bg-[#0E1F34]/90">
          ...
          <div className="flex flex-wrap items-end justify-center gap-1 pb-0.5">
            ...
            >
              ...
              <span className={dockLabelClass}>{m.mobile.home}</span>
            </NavLink>
            <NavLink
              className={({ isActive }) =>
                isActive
            ...
            >
              ...
              <span className={dockLabelClass}>{m.mobile.about}</span>
            </NavLink>
            <NavLink
              className={({ isActive }) =>
                isActive
            ...
            >
              ...
              <span className={dockLabelClass}>{m.mobile.innox}</span>
            </NavLink>
            <NavLink
              className={({ isActive }) =>
                isActive
            ...
            >
              ...
              <span className={dockLabelClass}>{m.mobile.services}</span>
            </NavLink>
            <NavLink
              className={({ isActive }) =>
                isActive
            ...
            >
              ...
              <span className={dockLabelClass}>{m.mobile.news}</span>
            </NavLink>
            <NavLink
              className={({ isActive }) =>
                isActive
            ...
            >
              ...
              <span className={dockLabelClass}>{m.mobile.contact}</span>
            </NavLink>
          </div>
        </div>
      </div>
