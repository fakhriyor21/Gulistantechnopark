...
import innox from "../assets/images/hero/innox.jpg";
    ...
    <div className="min-h-screen dark:bg-[#08101B]">
      ...
      <PageContent className="pt-6">
        <div className="flex flex-col gap-10 lg:flex-row lg:items-start lg:gap-12">
          <div className="flex w-full flex-col gap-4 lg:w-2/3">
            <p className="text-justify text-sm leading-relaxed text-[#33445F] dark:text-white/85 md:text-base">
              Xalqaro innovatsion g‘oyalar haftaligi — “Innox.uz”
        ...
        <div className="mt-12">
          <Quote
            title={
              "Innox haftaligi doirasida innovatsion mahsulotlardan foydalangan holda texnologik yechimlarni ishlab chiqish boʻyicha har yili oʻtkaziladigan tadbir. Turli xil muammolarga innovatsion yechimlar!"
            }
          />
        </div>
      </PageContent>
